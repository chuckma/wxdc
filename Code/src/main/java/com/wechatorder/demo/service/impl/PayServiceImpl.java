...
import com.wechatorder.demo.utils.MathUtil;
...
public class PayServiceImpl implements PayService {
    ...
    /**
     * 这里需要使用@Bean的方式引入BestPayServiceImpl，
     * 否则会出现错误：Field XXX required a bean of type XXX that could not be found.
     * 具体实现：在WechatPayConfig.java中实现
     */
    @Autowired
